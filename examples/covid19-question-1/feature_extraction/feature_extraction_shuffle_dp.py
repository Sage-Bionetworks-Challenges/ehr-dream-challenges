...
death = np.load("../syn_data/shuffled_death_dp.npy")
alive = np.load("../syn_data/shuffled_alive_dp.npy")
...
print(coef_list_syn)
print(coef_list_syn.shape)
coef_list_syn.to_csv('../coef/coef_shuffled_dp.csv',index = False)
...
print("score on syn_train_shuffled_dp{}".format(score1),flush = True)
print("score on infer_train on shuffled_dp{}".format(score2),flush = True)
print("score on real_train on shuffled_dp{}".format(score3),flush = True)
print("prauc score on syn_train_shuffled_dp{}".format(score4),flush = True)
print("prauc score on infer_train_shuffled_dp{}".format(score5),flush = True)
print("prauc score on real__train_shuffled_dp{}".format(score6),flush = True)
