...
death = np.load("../syn_data/medWGAN_death_binary.npy")
alive = np.load("../syn_data/medWGAN_alive_binary.npy")
...
print(coef_list_syn)
print(coef_list_syn.shape)
#coef_list_syn.to_csv('./coef/coef_medWGAN.csv',index = False)
coef_list_syn.to_csv('../coef/coef_medWGAN_binary.csv',index = False)
...
print("score on syn_train_medWGAN_binary{}".format(score1),flush = True)
print("score on infer_train on medWGAN_binary{}".format(score2),flush = True)
print("score on real_train on medWGAN_binary{}".format(score3),flush = True)
print("prauc score on syn_train_medWGAN_binary{}".format(score4),flush = True)
print("prauc score on infer_train_medWGAN_binary{}".format(score5),flush = True)
print("prauc score on real__train_medWGAN_binary{}".format(score6),flush = True)
