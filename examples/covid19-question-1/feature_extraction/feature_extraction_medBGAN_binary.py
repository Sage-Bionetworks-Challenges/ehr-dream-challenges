...
death = np.load("../syn_data/medBGAN_death_binary.npy")
alive = np.load("../syn_data/medBGAN_alive_binary.npy")
...
coef = coef.reshape((10697,1))
coef_list_syn = pd.DataFrame(coef, columns = ['coef'])
coef_list_syn.to_csv('../coef/coef_medBGAN_binary.csv',index = False)
...
print("score on syn_train_medBGAN_binary {}".format(score1),flush = True)
print("score on infer_train on medBGAN_binary {}".format(score2),flush = True)
print("score on real_train on medBGAN_binary {}".format(score3),flush = True)
print("prauc score on syn_train_medBGAN_binary {}".format(score4),flush = True)
print("prauc score on infer_train_medBGAN_binary {}".format(score5),flush = True)
print("prauc score on real__train_medBGAN_binary {}".format(score6),flush = True)
