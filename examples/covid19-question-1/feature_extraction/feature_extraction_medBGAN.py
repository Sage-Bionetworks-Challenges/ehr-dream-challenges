...
death = np.load("../syn_data/medBGAN_death.npy")
alive = np.load("../syn_data/medBGAN_alive.npy")
...
print(coef_list_syn)
print(coef_list_syn.shape)
coef_list_syn.to_csv('../coef/coef_medBGAN.csv',index = False)
...
print("score on syn_train_medBGAN{}".format(score1),flush = True)
print("score on infer_train on medBGAN{}".format(score2),flush = True)
print("score on real_train on medBGAN{}".format(score3),flush = True)
print("prauc score on syn_train_medBGAN{}".format(score4),flush = True)
print("prauc score on infer_train_medBGAN{}".format(score5),flush = True)
print("prauc score on real__train_medBGAN{}".format(score6),flush = True)
