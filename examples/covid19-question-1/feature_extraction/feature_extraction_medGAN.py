...
death = np.load("../syn_data/medGAN_death.npy")
alive = np.load("../syn_data/medGAN_alive.npy")
...
print(coef_list_syn)
print(coef_list_syn.shape)
coef_list_syn.to_csv('../coef/coef_medGAN.csv',index = False)
...
print("score on syn_train_medGAN{}".format(score1),flush = True)
print("score on infer_train on medGAN{}".format(score2),flush = True)
print("score on real_train on medGAN{}".format(score3),flush = True)
print("prauc score on syn_train_medGAN{}".format(score4),flush = True)
print("prauc score on infer_train_medGAN{}".format(score5),flush = True)
print("prauc score on real__train_medGAN{}".format(score6),flush = True)
