...
death = np.load("../syn_data/medWGAN_death.npy")
alive = np.load("../syn_data/medWGAN_alive.npy")
...
model.fit(shuffled_xr,shuffled_yr)
print("print coeficient")
...
print(coef_list_syn)
print(coef_list_syn.shape)
coef_list_syn.to_csv('../coef/coef_real_data.csv',index = False)
...
print("score on syn_train_real{}".format(score1),flush = True)
print("score on infer_train on real{}".format(score2),flush = True)
print("score on real_train on real{}".format(score3),flush = True)
print("prauc score on syn_train_real{}".format(score4),flush = True)
print("prauc score on infer_train_real{}".format(score5),flush = True)
print("prauc score on real__train_real{}".format(score6),flush = True)
