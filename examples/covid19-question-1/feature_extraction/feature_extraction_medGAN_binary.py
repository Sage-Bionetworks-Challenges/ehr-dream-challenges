...
death = np.load("../syn_data/medGAN_death_binary.npy")
alive = np.load("../syn_data/medGAN_alive_binary.npy")
...
print(coef_list_syn)
print(coef_list_syn.shape)
coef_list_syn.to_csv('../coef/coef_medGAN_binary.csv',index = False)
...
print("score on syn_train_medGAN_binary {}".format(score1),flush = True)
print("score on infer_train on medGAN_binary {}".format(score2),flush = True)
print("score on real_train on medGAN_binary {}".format(score3),flush = True)
print("prauc score on syn_train_medGAN_binary {}".format(score4),flush = True)
print("prauc score on infer_train_medGAN_binary {}".format(score5),flush = True)
print("prauc score on real__train_medGAN_binary {}".format(score6),flush = True)
