...
print("score on syn_train_medWGAN{}".format(score1),flush = True)
print("score on infer_train on medWGAN{}".format(score2),flush = True)
print("score on real_train on medWGAN{}".format(score3),flush = True)
print("prauc score on syn_train_medWGAN{}".format(score4),flush = True)
print("prauc score on infer_train_medWGAN{}".format(score5),flush = True)
print("prauc score on real__train_medWGAN{}".format(score6),flush = True)
