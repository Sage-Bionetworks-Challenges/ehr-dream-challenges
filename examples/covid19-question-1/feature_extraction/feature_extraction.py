...
death = np.load("medWGAN_death.npy")
alive = np.load("medWGAN_alive.npy")
...
print("score on train syn{}".format(score1),flush = True)
print("score on infer real{}".format(score2),flush = True)
print("score on itself-real_train{}".format(score3),flush = True)
print("prauc score on train syn{}".format(score4),flush = True)
print("prauc score on infer real{}".format(score5),flush = True)
print("prauc score on itself{}".format(score6),flush = True)
